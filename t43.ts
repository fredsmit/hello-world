...
const formControls: Element | RadioNodeList | null = form.elements.namedItem("one");
...
const genres: Element | RadioNodeList | null = form.elements.namedItem("genres");
...
emailInput.addEventListener("blur", function (this: HTMLInputElement, ev: FocusEvent): void {
...
function getViewHandler(htmlElement: HTMLElement) {
    ...
    textArea.addEventListener("blur", function (this: HTMLTextAreaElement, ev: FocusEvent): void {
        //console.log("textarea:ev.type:", ev.type, textArea);
        displayView();
    });

    textArea.addEventListener("keydown", function (this: HTMLTextAreaElement, ev: KeyboardEvent): void {
        if (ev.repeat)
            return;
    ...
    return function (this: HTMLElement, ev: FocusEvent): void {
