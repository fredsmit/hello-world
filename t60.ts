...
let uploader: Uploader | null | undefined;
const btnStop = queryRequiredElement(document.body, "button", "btnStop");
btnStop.addEventListener("click", function (this: HTMLButtonElement, ev: MouseEvent): void {
    if (uploader) {
...
function onProgress(loaded: number, total: number, lengthComputable: boolean): void {
