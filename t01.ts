...
async function main() {
    ...
    if (duplicate) return; // ← works perfectly
    ...
    for (const row of data) {
        ...
        for (const cell of row) {
            ...
            if (diff < 6) td.style.backgroundColor = "yellow";
            else if (diff === 6) td.style.backgroundColor = "lime";
            else td.style.backgroundColor = "orange";
