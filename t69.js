...
let regexp = /\d/g;
const result2 = str2.match(regexp);
console.log(result2);
console.log(result2?.join());
const s3 = "\n\n\nABC";
const result3 = s3.match(/^\s+A/mg);
...
function parseArithmeticExpression(expressionLiteral) {
...
function calc(arithmeticExpression) {
    const op = arithmeticExpression.op;
    let result;
    switch (op) {
        case "+":
...
arithmeticExpressions.forEach(arithmeticExpression => {
    ...
    if (arithmeticExpressionParsed) {
        ...
        console.log(arithmeticExpressionParsed.left, arithmeticExpressionParsed.op, arithmeticExpressionParsed.right, "=", calc(arithmeticExpressionParsed));
    }
    else {
...
console.log("------------------------------");
function replacer(substring, ...args) {
    console.log("substring:", substring);
