interface Arr<T> {
    ...
    // Returns a string representation of an array.
    // The elements are converted to string using their
    ...
    // separator: A string used to separate one element of the array
    ...
    // an offset from the end of the array. For example, -2 refers to the
    ...
    // It is expected to return a negative value if the first argument is
    ...
    // deleteCount: The number of elements to remove. Omitting this argument
    // will remove all elements from the start paramater location to end of the array.
    // If value of this argument is either a negative number, zero, undefined, or a type
    // that cannot be converted to an integer, the function will evaluate the argument
    ...
    // in their place, returning the deleted elements.
    // start: The zero-based location in the array from which to start removing elements.
    // deleteCount: The number of elements to remove. If value of this argument is either
    // a negative number, zero, undefined, or a type that cannot be converted to an integer,
    ...
    // or -1 if it is not present.
    // searchElement: The value to locate in the array.
    // fromIndex: The array index at which to begin searching backward.
    // If fromIndex is omitted, the search starts at the last index in the array.
    lastIndexOf(searchElement: T, fromIndex?: number): number;

    // Determines whether all the members of an array satisfy the specified test.
    // predicateL A function that accepts up to three arguments. The every method calls
    // the predicate function for each element in the array until the predicate returns
    ...
    // predicate: A function that accepts up to three arguments.
    // The filter method calls the predicate function one time for each element
    // in the array.
    // thisArg: An object to which the this keyword can refer in the predicate function.
    // If thisArg is omitted, undefined is used as the this value.
    ...
    // The reduce method calls the callbackfn function one time for each element
    // in the array.
    // initialValue: If initialValue is specified, it is used as the initial value
    // to start the accumulation. The first call to the callbackfn function provides
