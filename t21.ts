...
function onClickHandler(this: unknown, event: MouseEvent): void {
...
function getHandler(msg?: string, thisObject?: unknown): EventListenerObject {

    function handleEvent(this: unknown, ev: Event): void {
        const what = {
            msg: msg ?? "",
