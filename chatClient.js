import { getRequiredNamedForm, getRequiredNamedFormControl, getRequiredHTMLElements } from "./pageUtils.js";
...
const messageControl = getRequiredNamedFormControl(publishForm, "message", (c) => c instanceof HTMLInputElement);
...
webSocket.onopen = function (ev) {
    ...
    publishForm.onsubmit = function (ev) {
...
webSocket.onclose = (ev) => console.log(`Closed ${ev.code}, reason: ${ev.reason}, wasClean: ${ev.wasClean}`);
